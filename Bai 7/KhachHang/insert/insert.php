...
<body>
<table>
    <form name="frmPHP" method="post" action="sanpham_doinsert.php"
        ...
        <tr>
            <td align="left">
                <input type="text" name="txtid_sp" size="25"
        ...
        <tr>
            <td align="left">
                <input type="text" name="txttensanpham" size="50"
        ...
        <tr>
            <td align="left">
                <input type="text" name="txtdongia" size="12"
